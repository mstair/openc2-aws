...
VERSION = __import__('cloudslpf').get_version()
RELEASE_NAME = "cloudslpf-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "cloudslpf-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "cloudslpf")])
...
print("\nRemoving cloudslpf.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "cloudslpf.egg-info"))
