...
The PoC for cloud provider fws application requires a set of configuration files to operate.
...
PoC for cloud provider fws (cloudslpf.config)
---------------------------------------------

    The required ``cloudslpf.config`` file is used to configure the application.
